...
function MonthStoryText({ classes }) {
  return (
    <div className={classes.monthStoryParent}>
      <Typography component="body2" variant="body2" gutterBottom className={classes.monthStorySubtitle}>
            STORY OF THE MONTH
      </Typography>
      <Typography component="h1" variant="h1" gutterBottom className={classes.monthStoryTitle}>
            Main Article Title
      </Typography>
      <Typography variant="body1" gutterBottom className={classes.contentText}>
        Lorem ipsum dolor sit amet, conse ctetur adipis
        cing elit. Lorem ipsum dolor sit lorem. Conse
        ctetur adipiscing elit lorem init.
      </Typography>
